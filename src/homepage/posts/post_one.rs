...
impl PostOne {
    ...
    pub fn inner() -> Html {
        html! {
            <>
                <h1>{"About this blog, the process of making a website"}</h1>
                <p><i>{"Posted 18th of February 2026"}</i></p>
                <br/>
                <h2>{"About this blog"}</h2>
                <p>{"
                        An Idiot’s Brain Dump as the name suggests is a place for me to write about the random things I’ve been thinking. This site is mostly going to be full of me writing about Programming, Politics, and Philosophy, however I’ll be more than willing to expand into other areas if I’m interested. My goal is to publish a post weekly, holding myself to this standard is crucial, as I have a terrible habit of quitting projects early when losing interest. If I am able to write a post every week on a topic in which I am personally interested then I’ll hopefully avoid burn out and quitting. Before continuing please note that I am an awful writer, I often type faster than I think which results in typos at best and incoherent sentences at worst. I'll do my best to triple check all my posts before publishing but some mistakes are bound to slip through. 
                "} </p>
                <br/>
                <h2>{"Making a website the wrong way"}</h2>
                <p>
                {"
                    Before making this website I wasn’t a stranger to web development, I’ve dabbled in static HTML websites before, and even made a simple website in Svelte. However my recent fascination with the Rust programming Language has caused me to look into what I can create using this language. Well the first thing that came to mind was a website. I’ve always wanted a place to just write about my interests, without caring if anyone else would read them. Primarily to look back in the future and see how I thought, but also as a mental exercise. 
                "}
                </p>
                <p>
                {"
                    After some quick searching I found a tutorial on a blog called “Shesh’s blog”. This tutorial outlined how to use the Yew framework to create a website in Rust using Web-Assembly (It was an amazing tutorial I recommend checking it out if anyone is interested, link is at the bottom of the page). For anyone reading this who doesn’t know much about Web Development I'll give you a quick and simple explanation. (Feel free to skip to the next paragraph). Most websites a programmed in a language called “Javascript” this is a simple language but it has its faults. However, there is a second language that most modern web browsers support, Web-Assembly. Web-Assembly is a special language because it isn't designed to be written, it is designed to be an intermediate language that other languages compile their code into for running on the web. This allows other non-javascript languages to be used to create websites.
                ...
                <p>
                {"
                    After probably 10+ hours of work I had a crude yet working website built in what a lot of people consider the hardest programming language. Was it worth it? 100% the joy I felt seeing the site load for the first time after trouble shooting for 4 hours is impossible to explain. I definitely could've chosen the tools I used to make this website better, something like React for Javascript would’ve been infinity easier to debug but I think using the more obscure and difficult tools made the project much more enjoyable. This project perfectly encapsulates what I love about programming, the hours of problem solving that finally pays off with a working project, and the fact that I used more obscure and complex tools made this feeling so much sweeter (and the fact that I did not use any AI).
                "}
                </p>
                <p>
                {"
